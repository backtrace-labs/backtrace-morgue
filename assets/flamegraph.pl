...
# tunables
my $encoding;
my $fonttype = "Source Code Pro";
my $imagewidth = 1200;          # max width, pixels
my $frameheight = 16;           # max height is dynamic
my $fontsize = 9;              # base text size
my $fontwidth = 0.62;           # avg width relative to fontsize
my $minwidth = 0.1;             # min function width, pixels
my $nametype = "Function:";     # what are the names in the data?
my $countname = "crashes";      # what are the counts in the data?
my $colors = "hot";             # color theme
my $bgcolor1 = "#ffffff";       # background color gradient start
my $bgcolor2 = "#ffffff";       # background color gradient stop
