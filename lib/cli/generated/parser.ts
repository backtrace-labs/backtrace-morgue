...
export function createProgram(): { program: Command; getResult: () => CliCommand | undefined } {
  ...
  program.command('clean')
    ...
    .option('--unique <attribute>', 'Count distinct values')
    .option('--histogram <attribute>', 'Show all distinct values')
    .option('--distribution <attribute>', 'Show truncated histogram')
    .option('--mean <attribute>', 'Calculate mean')
    .option('--sum <attribute>', 'Sum all values')
    .option('--range <attribute>', 'Show min and max values')
    .option('--count <attribute>', 'Count non-null values')
    .option('--bin <attribute>', 'Linear histogram of values')
    .option('--head <attribute>', 'First value in factor')
    .option('--tail <attribute>', 'Last value in factor')
    .option('--object <attribute>', 'Maximum object identifier')
    .addOption(new Option('--last <attribute>', 'Last object identifier').hideHelp(!revealHidden))
    .addOption(new Option('--first <attribute>', 'First object identifier').hideHelp(!revealHidden))
    .addOption(new Option('--min <attribute>', 'Min object identifier').hideHelp(!revealHidden))
    .addOption(new Option('--max <attribute>', 'Max object identifier').hideHelp(!revealHidden))
