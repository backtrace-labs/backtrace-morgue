  ...
  if (attachments) {
    ...
    attachments.forEach(function(aobj) {
      if (typeof aobj === 'string') {
        ...
        throw new Error("Invalid attachment object type");
      }
      /* Without a Content-Type, the attachment part is treated as a KV. */
      if (typeof aobj.contentType !== 'string')
        aobj.contentType = "application/octet-stream";
      form.append('attachment', fs.createReadStream(aobj.filename), aobj);
    });
  }
};
