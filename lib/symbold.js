...
class SymboldClient {
  constructor(coronerdClient) {
    ...
    this.symboldEndpoint = `http://localhost:6447/api/symbold`;
    this.routing = {
  ...
  routeMethod(argv) {
    ...
    const handler = this.routing[handlerName];
    if (!handler) {
  ...
  showSymbolServerUsage(err) {
    ...
    console.warn(`
    Usage: morgue symbold symbolServer <subcommand>:
        ...
        morgue symbold whitelist add <symbolServerId> --add <--name=symbolName>
        ...
        morgue symbold blacklist <symbolServerId> -add <--name=symbolName>
        ...
        morgue symbold skiplist <symbolServerId> -add <--name=symbolName>
